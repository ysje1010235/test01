...
$(window).on('mousewheel DOMMouseScroll', function(e){
	...
	//direction = e.originalEvent.deltaY;	휠의 방향을 direction변수에 저장  이부분때문에 파폭에선 안됨 방향을 모름
	if(e.originalEvent.detail){
      direction = e.originalEvent.detail; //ff용
	}
	else{
	   direction = e.originalEvent.deltaY;	//ff제외브라우져
	}
